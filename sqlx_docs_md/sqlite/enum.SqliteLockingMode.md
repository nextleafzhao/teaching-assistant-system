...
# Enum SqliteLockingMode Copy item path
[code]
...
Refer to [SQLite documentation][4] for the meaning of the connection locking mode.
...
### impl [Clone][5] for [SqliteLockingMode][6]

§

#### fn [clone][7](&self) -> [SqliteLockingMode][6]
...
### impl [Debug][10] for [SqliteLockingMode][6]
...
### impl [Default][16] for [SqliteLockingMode][6]

§

#### fn [default][17]() -> [SqliteLockingMode][6]

Returns the “default value” for a type. [Read more][17]

§

### impl [FromStr][18] for [SqliteLockingMode][6]
...
#### fn [from_str][21](s: &[str][22]) -> [Result][13]<[SqliteLockingMode][6], [Error][20]>

Parses a string `s` to return a value of this type. [Read more][21]

§

### impl [PartialEq][23] for [SqliteLockingMode][6]

§

#### fn [eq][24](&self, other: &[SqliteLockingMode][6]) -> [bool][25]
...
### impl [Copy][29] for [SqliteLockingMode][6]

§

### impl [Eq][30] for [SqliteLockingMode][6]

§

### impl [StructuralPartialEq][31] for [SqliteLockingMode][6]

## Auto Trait Implementations§

§

### impl [Freeze][32] for [SqliteLockingMode][6]

§

### impl [RefUnwindSafe][33] for [SqliteLockingMode][6]

§

### impl [Send][34] for [SqliteLockingMode][6]

§

### impl [Sync][35] for [SqliteLockingMode][6]

§

### impl [Unpin][36] for [SqliteLockingMode][6]

§

### impl [UnwindSafe][37] for [SqliteLockingMode][6]
...
Attaches the current [default][105] [`Subscriber`][104] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [6]: enum.SqliteLockingMode.html (enum sqlx::sqlite::SqliteLockingMode)
