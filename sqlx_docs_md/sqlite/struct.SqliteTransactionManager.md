...
# Struct SqliteTransactionManager Copy item path
[code]
...
### impl [Freeze][4] for [SqliteTransactionManager][5]

§

### impl [RefUnwindSafe][6] for [SqliteTransactionManager][5]

§

### impl [Send][7] for [SqliteTransactionManager][5]

§

### impl [Sync][8] for [SqliteTransactionManager][5]

§

### impl [Unpin][9] for [SqliteTransactionManager][5]

§

### impl [UnwindSafe][10] for [SqliteTransactionManager][5]
...
Attaches the current [default][67] [`Subscriber`][66] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [5]: struct.SqliteTransactionManager.html (struct sqlx::sqlite::SqliteTransactionManager)
