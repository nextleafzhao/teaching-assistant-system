...
# Enum SqliteJournalMode Copy item path
[code]
...
Refer to [SQLite documentation][4] for the meaning of the database journaling mode.
...
### impl [Clone][5] for [SqliteJournalMode][6]

§

#### fn [clone][7](&self) -> [SqliteJournalMode][6]
...
### impl [Debug][10] for [SqliteJournalMode][6]
...
### impl [Default][16] for [SqliteJournalMode][6]

§

#### fn [default][17]() -> [SqliteJournalMode][6]

Returns the “default value” for a type. [Read more][17]

§

### impl [FromStr][18] for [SqliteJournalMode][6]
...
#### fn [from_str][21](s: &[str][22]) -> [Result][13]<[SqliteJournalMode][6], [Error][20]>

Parses a string `s` to return a value of this type. [Read more][21]

§

### impl [PartialEq][23] for [SqliteJournalMode][6]

§

#### fn [eq][24](&self, other: &[SqliteJournalMode][6]) -> [bool][25]
...
### impl [Copy][29] for [SqliteJournalMode][6]

§

### impl [Eq][30] for [SqliteJournalMode][6]

§

### impl [StructuralPartialEq][31] for [SqliteJournalMode][6]

## Auto Trait Implementations§

§

### impl [Freeze][32] for [SqliteJournalMode][6]

§

### impl [RefUnwindSafe][33] for [SqliteJournalMode][6]

§

### impl [Send][34] for [SqliteJournalMode][6]

§

### impl [Sync][35] for [SqliteJournalMode][6]

§

### impl [Unpin][36] for [SqliteJournalMode][6]

§

### impl [UnwindSafe][37] for [SqliteJournalMode][6]
...
Attaches the current [default][105] [`Subscriber`][104] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [2]: index.html
   [3]: ../index.html
   [4]: https://www.sqlite.org/pragma.html#pragma_journal_mode
   [5]: https://doc.rust-lang.org/1.94.1/core/clone/trait.Clone.html (trait core::clone::Clone)
   [6]: enum.SqliteJournalMode.html (enum sqlx::sqlite::SqliteJournalMode)
