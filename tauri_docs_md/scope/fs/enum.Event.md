...
# Enum Event Copy item path

[Source][6]
[code] 
    pub enum Event {
        PathAllowed([PathBuf][7]),
        PathForbidden([PathBuf][7]),
    }
[/code]
...
### impl [Clone][9] for [Event][10]

[Source][8]§

#### fn [clone][11](&self) -> [Event][10]
...
### impl [Freeze][18] for [Event][10]

§

### impl [RefUnwindSafe][19] for [Event][10]

§

### impl [Send][20] for [Event][10]

§

### impl [Sync][21] for [Event][10]

§

### impl [Unpin][22] for [Event][10]

§

### impl [UnwindSafe][23] for [Event][10]
...
where T: [Debug][14] \+ [Clone][9] \+ [Send][20] \+ 'static,
