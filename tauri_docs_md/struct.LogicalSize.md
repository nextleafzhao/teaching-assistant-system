...
# Struct LogicalSize Copy item path
[code]
...
### impl<P> [LogicalSize][4]<P>

#### pub const fn new(width: P, height: P) -> [LogicalSize][4]<P>
...
#### pub fn from_physical<T, X>(physical: T, scale_factor: [f64][6]) -> [LogicalSize][4]<P>

where T: [Into][7]<[PhysicalSize][8]<X>>, X: [Pixel][5],

#### pub fn to_physical<X>(&self, scale_factor: [f64][6]) -> [PhysicalSize][8]<X>

where X: [Pixel][5],

#### pub fn cast<X>(&self) -> [LogicalSize][4]<X>
...
### impl<P> [Clone][9] for [LogicalSize][4]<P>

where P: [Clone][9],

§

#### fn [clone][10](&self) -> [LogicalSize][4]<P>
...
### impl<P> [Debug][13] for [LogicalSize][4]<P>
...
### impl<P> [Default][19] for [LogicalSize][4]<P>

where P: [Default][19],

§

#### fn [default][20]() -> [LogicalSize][4]<P>

Returns the “default value” for a type. [Read more][20]

§

### impl<'de, P> [Deserialize][21]<'de> for [LogicalSize][4]<P>

where P: [Deserialize][21]<'de>,

§

#### fn [deserialize][22]<__D>( __deserializer: __D, ) -> [Result][16]<[LogicalSize][4]<P>, <__D as [Deserializer][23]<'de>>::[Error][24]>
...
### impl<P, X> [From][25]<[[X; 2]][26]> for [LogicalSize][4]<P>

where P: [Pixel][5], X: [Pixel][5],

§

#### fn [from][27](_: [[X; 2]][26]) -> [LogicalSize][4]<P>

Converts to this type from the input type.

§

### impl<P, X> [From][25]<[(X, X)][28]> for [LogicalSize][4]<P>

where P: [Pixel][5], X: [Pixel][5],

§

#### fn [from][27](_: [(X, X)][28]) -> [LogicalSize][4]<P>

Converts to this type from the input type.

§

### impl<P> [From][25]<[LogicalSize][4]<P>> for [Size][29]

where P: [Pixel][5],

§

#### fn [from][27](size: [LogicalSize][4]<P>) -> [Size][29]

Converts to this type from the input type.

§

### impl<P> [Hash][30] for [LogicalSize][4]<P>
...
### impl<P> [Ord][37] for [LogicalSize][4]<P>

where P: [Ord][37],

§

#### fn [cmp][38](&self, other: &[LogicalSize][4]<P>) -> [Ordering][39]
...
### impl<P> [PartialEq][46] for [LogicalSize][4]<P>

where P: [PartialEq][46],

§

#### fn [eq][47](&self, other: &[LogicalSize][4]<P>) -> [bool][48]
...
### impl<P> [PartialOrd][51] for [LogicalSize][4]<P>

where P: [PartialOrd][51],

§

#### fn [partial_cmp][52](&self, other: &[LogicalSize][4]<P>) -> [Option][53]<[Ordering][39]>
...
### impl<P> [Serialize][62] for [LogicalSize][4]<P>
...
### impl<P> [Copy][67] for [LogicalSize][4]<P>

where P: [Copy][67],

§

### impl<P> [Eq][68] for [LogicalSize][4]<P>

where P: [Eq][68],

§

### impl<P> [StructuralPartialEq][69] for [LogicalSize][4]<P>

## Auto Trait Implementations§

§

### impl<P> [Freeze][70] for [LogicalSize][4]<P>

where P: [Freeze][70],

§

### impl<P> [RefUnwindSafe][71] for [LogicalSize][4]<P>

where P: [RefUnwindSafe][71],

§

### impl<P> [Send][72] for [LogicalSize][4]<P>

where P: [Send][72],

§

### impl<P> [Sync][73] for [LogicalSize][4]<P>

where P: [Sync][73],

§

### impl<P> [Unpin][74] for [LogicalSize][4]<P>

where P: [Unpin][74],

§

### impl<P> [UnwindSafe][75] for [LogicalSize][4]<P>
...
where T: [Debug][13] \+ [Clone][9] \+ [Send][72] \+ 'static,
   ...
   [2]: ../tauri/index.html
   [3]: index.html
   [4]: struct.LogicalSize.html (struct tauri::LogicalSize)
   ...
   [8]: struct.PhysicalSize.html (struct tauri::PhysicalSize)
