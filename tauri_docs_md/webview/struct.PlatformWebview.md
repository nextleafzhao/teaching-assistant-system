...
# Struct PlatformWebview Copy item path
...
The platform webview handle. Accessed with [`Webview`][6];

## Implementations§

[Source][7]§

### impl [PlatformWebview][8]
...
### impl [Freeze][11] for [PlatformWebview][8]

§

### impl [RefUnwindSafe][12] for [PlatformWebview][8]

§

### impl ![Send][13] for [PlatformWebview][8]

§

### impl ![Sync][14] for [PlatformWebview][8]

§

### impl [Unpin][15] for [PlatformWebview][8]

§

### impl [UnwindSafe][16] for [PlatformWebview][8]
...
Performs the conversion.
   ...
   [3]: index.html
   [4]: ../index.html
   [5]: ../../src/tauri/webview/mod.rs.html#152
   [6]: struct.Webview.html#method.with_webview (struct tauri::webview::Webview)
   [7]: ../../src/tauri/webview/mod.rs.html#155-237
   [8]: struct.PlatformWebview.html (struct tauri::webview::PlatformWebview)
   [9]: ../../src/tauri/webview/mod.rs.html#181-185
   [10]: ../../src/tauri/webview/mod.rs.html#190-194
