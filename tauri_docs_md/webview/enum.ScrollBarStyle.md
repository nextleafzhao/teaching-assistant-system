...
# Enum ScrollBarStyle Copy item path
[code]
    #[non_exhaustive]
...
### impl [Clone][5] for [ScrollBarStyle][6]

§

#### fn [clone][7](&self) -> [ScrollBarStyle][6]
...
### impl [Debug][10] for [ScrollBarStyle][6]
...
### impl [Default][16] for [ScrollBarStyle][6]

§

#### fn [default][17]() -> [ScrollBarStyle][6]

Returns the “default value” for a type. [Read more][17]

§

### impl [Copy][18] for [ScrollBarStyle][6]

## Auto Trait Implementations§

§

### impl [Freeze][19] for [ScrollBarStyle][6]

§

### impl [RefUnwindSafe][20] for [ScrollBarStyle][6]

§

### impl [Send][21] for [ScrollBarStyle][6]

§

### impl [Sync][22] for [ScrollBarStyle][6]

§

### impl [Unpin][23] for [ScrollBarStyle][6]

§

### impl [UnwindSafe][24] for [ScrollBarStyle][6]
...
where T: [Debug][10] \+ [Clone][5] \+ [Send][21] \+ 'static,
   ...
   [6]: enum.ScrollBarStyle.html (enum tauri::webview::ScrollBarStyle)
   ...
   [18]: https://doc.rust-lang.org/1.94.1/core/marker/trait.Copy.html (trait core::marker::Copy)
