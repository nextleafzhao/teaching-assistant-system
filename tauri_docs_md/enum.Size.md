...
# Enum Size Copy item path
[code]
    pub enum Size {
        Physical([PhysicalSize][4]<[u32][5]>),
        Logical([LogicalSize][6]<[f64][7]>),
    }
[/code]
...
#### pub fn new<S>(size: S) -> [Size][8]

where S: [Into][9]<[Size][8]>,

#### pub fn to_logical<P>(&self, scale_factor: [f64][7]) -> [LogicalSize][6]<P>

where P: [Pixel][10],

#### pub fn to_physical<P>(&self, scale_factor: [f64][7]) -> [PhysicalSize][4]<P>

where P: [Pixel][10],

#### pub fn clamp<S>(input: S, min: S, max: S, scale_factor: [f64][7]) -> [Size][8]
...
### impl [Clone][11] for [Size][8]

§

#### fn [clone][12](&self) -> [Size][8]
...
### impl<'de> [Deserialize][21]<'de> for [Size][8]

§

#### fn [deserialize][22]<__D>( __deserializer: __D, ) -> [Result][18]<[Size][8], <__D as [Deserializer][23]<'de>>::[Error][24]>
...
### impl<P> [From][25]<[LogicalSize][6]<P>> for [Size][8]

where P: [Pixel][10],

§

#### fn [from][26](size: [LogicalSize][6]<P>) -> [Size][8]

Converts to this type from the input type.

§

### impl<P> [From][25]<[PhysicalSize][4]<P>> for [Size][8]

where P: [Pixel][10],

§

#### fn [from][26](size: [PhysicalSize][4]<P>) -> [Size][8]

Converts to this type from the input type.

§

### impl [PartialEq][27] for [Size][8]

§

#### fn [eq][28](&self, other: &[Size][8]) -> [bool][29]
...
### impl [Copy][38] for [Size][8]

§

### impl [StructuralPartialEq][39] for [Size][8]

## Auto Trait Implementations§

§

### impl [Freeze][40] for [Size][8]

§

### impl [RefUnwindSafe][41] for [Size][8]

§

### impl [Send][42] for [Size][8]

§

### impl [Sync][43] for [Size][8]

§

### impl [Unpin][44] for [Size][8]

§

### impl [UnwindSafe][45] for [Size][8]
