...
# Enum EffectState Copy item path
[code]
...
### impl [Clone][5] for [WindowEffectState][6]

§

#### fn [clone][7](&self) -> [WindowEffectState][6]
...
### impl [Debug][10] for [WindowEffectState][6]
...
### impl<'de> [Deserialize][16]<'de> for [WindowEffectState][6]

§

#### fn [deserialize][17]<__D>( __deserializer: __D, ) -> [Result][13]<[WindowEffectState][6], <__D as [Deserializer][18]<'de>>::[Error][19]>
...
### impl [PartialEq][20] for [WindowEffectState][6]

§

#### fn [eq][21](&self, other: &[WindowEffectState][6]) -> [bool][22]
...
### impl [Serialize][26] for [WindowEffectState][6]
...
### impl [Copy][31] for [WindowEffectState][6]

§

### impl [Eq][32] for [WindowEffectState][6]

§

### impl [StructuralPartialEq][33] for [WindowEffectState][6]

## Auto Trait Implementations§

§

### impl [Freeze][34] for [WindowEffectState][6]

§

### impl [RefUnwindSafe][35] for [WindowEffectState][6]

§

### impl [Send][36] for [WindowEffectState][6]

§

### impl [Sync][37] for [WindowEffectState][6]

§

### impl [Unpin][38] for [WindowEffectState][6]

§

### impl [UnwindSafe][39] for [WindowEffectState][6]
...
where T: [Debug][10] \+ [Clone][5] \+ [Send][36] \+ 'static,
   ...
   [6]: enum.EffectState.html (enum tauri::window::EffectState)
