...
### Trait Implementations
  ...
  * From<PhysicalPositionWrapper<T>>
  * From<[X; 2]>
  * Hash
  * Ord
  * PartialEq
...
# Struct PhysicalPosition Copy item path
[code]
...
### impl<P> [PhysicalPosition][4]<P>

#### pub const fn new(x: P, y: P) -> [PhysicalPosition][4]<P>
...
#### pub fn from_logical<T, X>(logical: T, scale_factor: [f64][6]) -> [PhysicalPosition][4]<P>

where T: [Into][7]<[LogicalPosition][8]<X>>, X: [Pixel][5],

#### pub fn to_logical<X>(&self, scale_factor: [f64][6]) -> [LogicalPosition][8]<X>

where X: [Pixel][5],

#### pub fn cast<X>(&self) -> [PhysicalPosition][4]<X>
...
### impl<P> [Clone][9] for [PhysicalPosition][4]<P>

where P: [Clone][9],

§

#### fn [clone][10](&self) -> [PhysicalPosition][4]<P>
...
### impl<P> [Debug][13] for [PhysicalPosition][4]<P>
...
### impl<P> [Default][19] for [PhysicalPosition][4]<P>

where P: [Default][19],

§

#### fn [default][20]() -> [PhysicalPosition][4]<P>

Returns the “default value” for a type. [Read more][20]

§

### impl<'de, P> [Deserialize][21]<'de> for [PhysicalPosition][4]<P>

where P: [Deserialize][21]<'de>,

§

#### fn [deserialize][22]<__D>( __deserializer: __D, ) -> [Result][16]<[PhysicalPosition][4]<P>, <__D as [Deserializer][23]<'de>>::[Error][24]>
...
### impl<P, X> [From][25]<[[X; 2]][26]> for [PhysicalPosition][4]<P>

where P: [Pixel][5], X: [Pixel][5],

§

#### fn [from][27](_: [[X; 2]][26]) -> [PhysicalPosition][4]<P>

Converts to this type from the input type.

§

### impl<P, X> [From][25]<[(X, X)][28]> for [PhysicalPosition][4]<P>

where P: [Pixel][5], X: [Pixel][5],

§

#### fn [from][27](_: [(X, X)][28]) -> [PhysicalPosition][4]<P>

Converts to this type from the input type.

§

### impl<P> [From][25]<[PhysicalPosition][4]<P>> for [Position][29]

where P: [Pixel][5],

§

#### fn [from][27](position: [PhysicalPosition][4]<P>) -> [Position][29]

Converts to this type from the input type.

§

### impl<T> [From][25]<PhysicalPositionWrapper<T>> for [PhysicalPosition][4]<T>

§

#### fn [from][27](position: PhysicalPositionWrapper<T>) -> [PhysicalPosition][4]<T>

Converts to this type from the input type.

§

### impl<P> [Hash][30] for [PhysicalPosition][4]<P>
...
### impl<P> [Ord][37] for [PhysicalPosition][4]<P>

where P: [Ord][37],

§

#### fn [cmp][38](&self, other: &[PhysicalPosition][4]<P>) -> [Ordering][39]
...
### impl<P> [PartialEq][46] for [PhysicalPosition][4]<P>

where P: [PartialEq][46],

§

#### fn [eq][47](&self, other: &[PhysicalPosition][4]<P>) -> [bool][48]
...
### impl<P> [PartialOrd][51] for [PhysicalPosition][4]<P>

where P: [PartialOrd][51],

§

#### fn [partial_cmp][52](&self, other: &[PhysicalPosition][4]<P>) -> [Option][53]<[Ordering][39]>
...
### impl<P> [Serialize][62] for [PhysicalPosition][4]<P>
...
### impl<P> [Copy][67] for [PhysicalPosition][4]<P>

where P: [Copy][67],

§

### impl<P> [Eq][68] for [PhysicalPosition][4]<P>

where P: [Eq][68],

§

### impl<P> [StructuralPartialEq][69] for [PhysicalPosition][4]<P>

## Auto Trait Implementations§

§

### impl<P> [Freeze][70] for [PhysicalPosition][4]<P>

where P: [Freeze][70],

§

### impl<P> [RefUnwindSafe][71] for [PhysicalPosition][4]<P>

where P: [RefUnwindSafe][71],

§

### impl<P> [Send][72] for [PhysicalPosition][4]<P>

where P: [Send][72],

§

### impl<P> [Sync][73] for [PhysicalPosition][4]<P>

where P: [Sync][73],

§

### impl<P> [Unpin][74] for [PhysicalPosition][4]<P>

where P: [Unpin][74],

§

### impl<P> [UnwindSafe][75] for [PhysicalPosition][4]<P>
...
where T: [Debug][13] \+ [Clone][9] \+ [Send][72] \+ 'static,
   ...
   [8]: struct.LogicalPosition.html (struct tauri::LogicalPosition)
