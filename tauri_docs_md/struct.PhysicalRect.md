...
# Struct PhysicalRect Copy item path
[code]
    ...
    {
        pub position: [PhysicalPosition][5]<P>,
        pub size: [PhysicalSize][6]<S>,
    }
[/code]
...
§`position: [PhysicalPosition][5]<P>`

Rect position.

§`size: [PhysicalSize][6]<S>`
...
### impl<P, S> [Clone][7] for [PhysicalRect][8]<P, S>

where P: [Clone][7] \+ [Pixel][4], S: [Clone][7] \+ [Pixel][4],

§

#### fn [clone][9](&self) -> [PhysicalRect][8]<P, S>
...
### impl<P, S> [Debug][12] for [PhysicalRect][8]<P, S>
...
### impl<P, S> [Default][18] for [PhysicalRect][8]<P, S>

where P: [Pixel][4], S: [Pixel][4],

§

#### fn [default][19]() -> [PhysicalRect][8]<P, S>

Returns the “default value” for a type. [Read more][19]

§

### impl<P, S> [Serialize][20] for [PhysicalRect][8]<P, S>
...
### impl<P, S> [Copy][25] for [PhysicalRect][8]<P, S>
...
### impl<P, S> [Freeze][26] for [PhysicalRect][8]<P, S>

where P: [Freeze][26], S: [Freeze][26],

§

### impl<P, S> [RefUnwindSafe][27] for [PhysicalRect][8]<P, S>

where P: [RefUnwindSafe][27], S: [RefUnwindSafe][27],

§

### impl<P, S> [Send][28] for [PhysicalRect][8]<P, S>

where P: [Send][28], S: [Send][28],

§

### impl<P, S> [Sync][29] for [PhysicalRect][8]<P, S>

where P: [Sync][29], S: [Sync][29],

§

### impl<P, S> [Unpin][30] for [PhysicalRect][8]<P, S>

where P: [Unpin][30], S: [Unpin][30],

§

### impl<P, S> [UnwindSafe][31] for [PhysicalRect][8]<P, S>
...
where T: [Debug][12] \+ [Clone][7] \+ [Send][28] \+ 'static,
   ...
   [5]: struct.PhysicalPosition.html (struct tauri::PhysicalPosition)
   [6]: struct.PhysicalSize.html (struct tauri::PhysicalSize)
   [7]: https://doc.rust-lang.org/1.94.1/core/clone/trait.Clone.html (trait core::clone::Clone)
   [8]: struct.PhysicalRect.html (struct tauri::PhysicalRect)
