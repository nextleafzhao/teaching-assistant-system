...
# Struct PhysicalUnit Copy item path
[code]
...
### impl<P> [PhysicalUnit][4]<P>

#### pub const MAX: [LogicalUnit][5]<[f64][6]>

Represents a maximum physical unit that is equal to [`f64::MAX`][7].

#### pub const MIN: [LogicalUnit][5]<[f64][6]>

Represents a minimum physical unit of [`f64::MAX`][7].

#### pub const ZERO: [LogicalUnit][5]<[f64][6]>

Represents a physical unit of `0_f64`.

#### pub const fn new(v: P) -> [PhysicalUnit][4]<P>
...
#### pub fn from_logical<T, X>(logical: T, scale_factor: [f64][6]) -> [PhysicalUnit][4]<P>

where T: [Into][9]<[LogicalUnit][5]<X>>, X: [Pixel][8],

#### pub fn to_logical<X>(&self, scale_factor: [f64][6]) -> [LogicalUnit][5]<X>

where X: [Pixel][8],

#### pub fn cast<X>(&self) -> [PhysicalUnit][4]<X>
...
### impl<P> [Clone][10] for [PhysicalUnit][4]<P>

where P: [Clone][10],

§

#### fn [clone][11](&self) -> [PhysicalUnit][4]<P>
...
### impl<P> [Debug][14] for [PhysicalUnit][4]<P>
...
### impl<P> [Default][20] for [PhysicalUnit][4]<P>

where P: [Default][20],

§

#### fn [default][21]() -> [PhysicalUnit][4]<P>

Returns the “default value” for a type. [Read more][21]

§

### impl<'de, P> [Deserialize][22]<'de> for [PhysicalUnit][4]<P>

where P: [Deserialize][22]<'de>,

§

#### fn [deserialize][23]<__D>( __deserializer: __D, ) -> [Result][17]<[PhysicalUnit][4]<P>, <__D as [Deserializer][24]<'de>>::[Error][25]>
...
### impl<P> [From][26]<[PhysicalUnit][4]<P>> for [PixelUnit][27]

where P: [Pixel][8],

§

#### fn [from][28](unit: [PhysicalUnit][4]<P>) -> [PixelUnit][27]

Converts to this type from the input type.

§

### impl<P, X> [From][26]<X> for [PhysicalUnit][4]<P>

where P: [Pixel][8], X: [Pixel][8],

§

#### fn [from][28](v: X) -> [PhysicalUnit][4]<P>

Converts to this type from the input type.

§

### impl<P> [Hash][29] for [PhysicalUnit][4]<P>
...
### impl<P> [Ord][36] for [PhysicalUnit][4]<P>

where P: [Ord][36],

§

#### fn [cmp][37](&self, other: &[PhysicalUnit][4]<P>) -> [Ordering][38]
...
### impl<P> [PartialEq][45] for [PhysicalUnit][4]<P>

where P: [PartialEq][45],

§

#### fn [eq][46](&self, other: &[PhysicalUnit][4]<P>) -> [bool][47]
...
### impl<P> [PartialOrd][50] for [PhysicalUnit][4]<P>

where P: [PartialOrd][50],

§

#### fn [partial_cmp][51](&self, other: &[PhysicalUnit][4]<P>) -> [Option][52]<[Ordering][38]>
...
### impl<P> [Serialize][61] for [PhysicalUnit][4]<P>
...
### impl<P> [Copy][66] for [PhysicalUnit][4]<P>

where P: [Copy][66],

§

### impl<P> [Eq][67] for [PhysicalUnit][4]<P>

where P: [Eq][67],

§

### impl<P> [StructuralPartialEq][68] for [PhysicalUnit][4]<P>

## Auto Trait Implementations§

§

### impl<P> [Freeze][69] for [PhysicalUnit][4]<P>

where P: [Freeze][69],

§

### impl<P> [RefUnwindSafe][70] for [PhysicalUnit][4]<P>

where P: [RefUnwindSafe][70],

§

### impl<P> [Send][71] for [PhysicalUnit][4]<P>

where P: [Send][71],

§

### impl<P> [Sync][72] for [PhysicalUnit][4]<P>

where P: [Sync][72],

§

### impl<P> [Unpin][73] for [PhysicalUnit][4]<P>

where P: [Unpin][73],

§

### impl<P> [UnwindSafe][74] for [PhysicalUnit][4]<P>
...
where T: [Debug][14] \+ [Clone][10] \+ [Send][71] \+ 'static,
   ...
   [5]: struct.LogicalUnit.html (struct tauri::LogicalUnit)
   [6]: https://doc.rust-lang.org/1.94.1/std/primitive.f64.html
   [7]: https://doc.rust-lang.org/1.94.1/std/primitive.f64.html#associatedconstant.MAX (associated constant f64::MAX)
   [8]: trait.Pixel.html (trait tauri::Pixel)
