...
# Struct Invoke Copy item path

[Source][5]
[code] 
    pub struct Invoke<R: [Runtime][6] = [Wry][7]> {
        pub message: [InvokeMessage][8]<R>,
        pub resolver: [InvokeResolver][9]<R>,
        pub acl: [Option][10]<[Vec][11]<ResolvedCommand>>,
    }
[/code]
...
§`message: [InvokeMessage][8]<R>`

The message passed.

§`resolver: [InvokeResolver][9]<R>`

The resolver of the message.

§`acl: [Option][10]<[Vec][11]<ResolvedCommand>>`
...
### impl<R> [Freeze][12] for [Invoke][13]<R>

where <R as Runtime<[EventLoopMessage][14]>>::WebviewDispatcher: [Freeze][12], <R as Runtime<[EventLoopMessage][14]>>::Handle: [Freeze][12],

§

### impl<R = Wry<[EventLoopMessage][14]>> ![RefUnwindSafe][15] for [Invoke][13]<R>

§

### impl<R> [Send][16] for [Invoke][13]<R>

§

### impl<R> [Sync][17] for [Invoke][13]<R>

§

### impl<R> [Unpin][18] for [Invoke][13]<R>

where <R as Runtime<[EventLoopMessage][14]>>::WebviewDispatcher: [Unpin][18], <R as Runtime<[EventLoopMessage][14]>>::Handle: [Unpin][18],

§

### impl<R = Wry<[EventLoopMessage][14]>> ![UnwindSafe][19] for [Invoke][13]<R>
...
Performs the conversion.
   ...
   [3]: index.html
   [4]: ../index.html
   [5]: ../../src/tauri/ipc/mod.rs.html#211-220
   ...
   [11]: https://doc.rust-lang.org/1.94.1/alloc/vec/struct.Vec.html (struct alloc::vec::Vec)
   [12]: https://doc.rust-lang.org/1.94.1/core/marker/trait.Freeze.html (trait core::marker::Freeze)
   [13]: struct.Invoke.html (struct tauri::ipc::Invoke)
   [14]: ../enum.EventLoopMessage.html (enum tauri::EventLoopMessage)
